...
description: 阻断发布的形式化质量门禁：测试、静态质量、安全、性能、可靠性、文档门禁，PASS/FAIL 判定。配置 CI 质量检查或评估发布就绪度时使用。
---
...
Exception process: a High finding may be accepted with a documented exception (justification, compensating controls, expiry date, owner). See `安全测试/SKILL.md`.
...
*Internal references*: `cicd流水线/SKILL.md`, `测试策略/SKILL.md`, `安全测试/SKILL.md`, `发布管理/SKILL.md`
