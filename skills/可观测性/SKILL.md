...
description: 基于 OpenTelemetry 的日志、指标与链路追踪：结构化 JSON 日志、4 个黄金信号、分布式追踪、基于 SLO 的告警。为服务加埋点、搭建监控、配置告警或排查生产问题时使用。
---
...
Cross-reference: `事件驱动架构/SKILL.md` for CloudEvents format and delivery guarantees.
...
Cross-reference: `云成本治理/SKILL.md` for cost management as an architectural discipline.
...
*Internal references*: `上线就绪评审/SKILL.md`, `安全设计/SKILL.md`, `cicd流水线/SKILL.md`, `错误处理与韧性/SKILL.md`
