...
description: 基于 CloudEvents 与 GCP Pub/Sub 的事件驱动系统：事件设计、schema 演进、投递保证、幂等、最终一致性。设计事件系统、发布/消费事件或实现异步工作流时使用。
---
...
For the outbox table schema, see `数据建模/SKILL.md`.
...
*Internal references*: `数据建模/SKILL.md`, `可观测性/SKILL.md`, `基础设施即代码/SKILL.md`, `微服务模式/SKILL.md`
