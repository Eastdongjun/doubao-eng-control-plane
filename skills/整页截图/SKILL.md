...
- [`engineering/browser-automation`](../浏览器自动化/SKILL.md) — General browser automation patterns via CDP/Playwright
- [`engineering/performance-profiler`](../性能剖析/SKILL.md) — Performance analysis that may complement visual captures
