...
description: 架构评审的治理与引导：普及型、决策型、轻量型评审；申请方准备、引导指南、结果记录。准备架构评审、评估方案或建立评审治理时使用。
---
...
6. **ADR draft**: follows `架构决策记录/SKILL.md` format, status set to `proposed`
...
*Internal references*: `架构决策记录/SKILL.md`, `架构沟通/SKILL.md`, `非功能需求/SKILL.md`, `权衡分析/SKILL.md`, `架构风险评估/SKILL.md`
