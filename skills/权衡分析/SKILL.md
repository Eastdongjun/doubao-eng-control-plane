...
description: 架构决策的系统性权衡分析：结构化评估方法、加权评分、可逆性评估、变更成本估算。评估架构备选方案、做技术选型或记录决策理由时使用。
---
...
*Internal references*: `架构决策记录/SKILL.md`, `非功能需求/SKILL.md`, `架构风险评估/SKILL.md`, `架构评审引导/SKILL.md`
