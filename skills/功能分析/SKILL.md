...
description: 连接业务需求与架构的功能分析：领域分析、事件风暴、用例规格、限界上下文映射。分解业务流程、分析领域或产出技术设计前的功能规格时使用。
---
...
*Internal references*: `集成设计/SKILL.md`, `非功能需求/SKILL.md`, `微服务模式/SKILL.md`, `数据建模/SKILL.md`, `事件驱动架构/SKILL.md`
