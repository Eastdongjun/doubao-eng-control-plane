...
| Skill | Relationship |
|-------|-------------|
| [threat-detection](../威胁检测/SKILL.md) | Confirmed hunting findings escalate to incident-response for triage and classification |
| [cloud-security](../云安全/SKILL.md) | Cloud posture findings (IAM compromise, S3 exposure) may trigger incident classification |
| [red-team](../红队/SKILL.md) | Red team findings validate detection coverage; confirmed gaps become hunting hypotheses |
| [security-pen-testing](../渗透测试/SKILL.md) | Pen test vulnerabilities exploited in the wild escalate to incident-response for active incident handling |
