...
description: 用 GitHub Actions 设计 CI/CD 流水线：流水线阶段、缓存、环境、蓝绿部署和金丝雀发布。搭建 CI/CD、编写 GitHub Actions 工作流或配置部署流水线时使用。
---
...
| # | Stage | What |
|---|-------|------|
| 9 | **Container Build** | Multi-stage Docker build (see `容器化/SKILL.md`) |
...
CI must produce artifacts usable for compliance evidence (see `合规与隐私/SKILL.md`):
...
*Internal references*: `容器化/SKILL.md`, `测试策略/SKILL.md`, `功能开关/SKILL.md`, `质量门禁/SKILL.md`, `发布管理/SKILL.md`
