...
description: 向干系人传达架构决策：架构评审、ADR 陈述、按受众调整的沟通。准备架构评审、陈述技术决策或为不同受众写文档时使用。
---
...
- Retention and deletion policy (link to `合规与隐私/SKILL.md`)
...
- AuthN/AuthZ model (link to `认证与授权/SKILL.md`)
...
*Internal references*: `架构决策记录/SKILL.md`, `架构绘图/SKILL.md`, `技术文档/SKILL.md`, `上线就绪评审/SKILL.md`
