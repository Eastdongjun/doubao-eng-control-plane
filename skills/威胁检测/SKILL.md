...
| Skill | Relationship |
|-------|-------------|
| [incident-response](../事故响应/SKILL.md) | Confirmed threats from hunting escalate to incident-response for triage and containment |
| [red-team](../红队/SKILL.md) | Red team exercises generate realistic TTPs that inform hunt hypothesis prioritization |
| [cloud-security](../云安全/SKILL.md) | Cloud posture findings (open S3, IAM wildcards) create hunting targets for data exfiltration TTPs |
| [security-pen-testing](../渗透测试/SKILL.md) | Pen test findings identify attack surfaces that threat hunting should monitor post-remediation |
