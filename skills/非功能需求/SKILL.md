...
description: 用 ISO 25010 质量模型定义非功能需求：质量属性场景（SEI 方法）、NFR 获取、优先级与验证。定义质量属性、从干系人获取 NFR 或将 NFR 映射到架构决策时使用。
---
...
*Internal references*: `架构决策记录/SKILL.md`, `适应度函数/SKILL.md`, `权衡分析/SKILL.md`, `可观测性/SKILL.md`, `性能测试/SKILL.md`, `上线就绪评审/SKILL.md`
