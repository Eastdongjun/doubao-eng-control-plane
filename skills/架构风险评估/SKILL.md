...
description: 架构风险识别、评估与缓解：风险登记册、假设映射、依赖分析、失效模式分析。评估技术风险、向干系人传达风险或将技术债映射为架构风险时使用。
---
...
*Internal references*: `架构决策记录/SKILL.md`, `权衡分析/SKILL.md`, `非功能需求/SKILL.md`, `上线就绪评审/SKILL.md`, `事故管理/SKILL.md`
